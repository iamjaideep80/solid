#ifndef __SOP_Solid_Extract_Sim_h__
#define __SOP_Solid_Extract_Sim_h__
...
{
	class SOP_Solid_Extract_Sim : public SOP_Node
	{
	public:
		SOP_Solid_Extract_Sim(OP_Network *net, const char *name, OP_Operator *op);
		virtual ~SOP_Solid_Extract_Sim();
